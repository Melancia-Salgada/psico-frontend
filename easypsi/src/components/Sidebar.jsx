...
const Sidebar = () => {
  return (
    <div className='fixed top-0 left-0 w-24 h-screen drop-shadow-[0_0_20px_rgba(0,0,0,0.6)]'>
        <div className='container h-full bg-azul'>
          <div className='flex flex-col justify-between h-full'>
            ...
            <div className='flex flex-col items-center justify-between mt-16'>
              ...
              <a href='/pacientes' className='mb-16'>
                <svg width="30" height="30" viewBox="0 0 42 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M30.0909 30.9994V27.6661C30.0909 25.898 29.3247 24.2024 27.9608 22.9521C26.5969 21.7019 24.747 20.9995 22.8182 20.9995H8.27273C6.34388 20.9995 4.49403 21.7019 3.13013 22.9521C1.76623 24.2024 1 25.898 1 27.6661V30.9994" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M15.5462 14.3332C19.5628 14.3332 22.8189 11.3485 22.8189 7.66661C22.8189 3.98474 19.5628 1 15.5462 1C11.5295 1 8.27344 3.98474 8.27344 7.66661C8.27344 11.3485 11.5295 14.3332 15.5462 14.3332Z" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M40.9995 30.9991V27.6658C40.9983 26.1887 40.4619 24.7537 39.4747 23.5863C38.4874 22.4189 37.1052 21.5851 35.5449 21.2158" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M28.2734 1.2168C29.8378 1.58396 31.2244 2.41796 32.2146 3.58729C33.2048 4.75663 33.7422 6.19481 33.7422 7.67508C33.7422 9.15535 33.2048 10.5935 32.2146 11.7629C31.2244 12.9322 29.8378 13.7662 28.2734 14.1334" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
            </div>
            ...
            <div className='flex flex-col items-center justify-between mb-16'>
              ...
              <a href='/' className=''>
                <svg width="30" height="30" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.9998 31H4.33328C3.44924 31 2.60141 30.6488 1.97629 30.0237C1.35118 29.3986 1 28.5507 1 27.6667V4.33333C1 3.44928 1.35118 2.60143 1.97629 1.97631C2.60141 1.35119 3.44924 1 4.33328 1H10.9998" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M22.666 24.3332L30.9992 15.9998L22.666 7.6665" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M30.9997 16H11" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
            </div>
